<div class="container-fluid">
	<p class="h2 mt-4 text-success"><?php echo $page_heading; ?></p>
	
	<div class="clearfix">&nbsp</div>
	
	<form name="frm_add_income" id="frm_add_income">
		<div class="form-row">
			...
			<div class="form-group col-md-6">
				...
				<input type="text" class="form-control datepicker" id="income_date" readonly="readonly" placeholder="yyyy-mm-dd" value="<?php echo (isset($data['income_date']) && !empty($data['income_date']) && $data['income_date']!="0000-00-00 00:00:00")?date("Y-m-d",strtotime($data['income_date'])):date("Y-m-d"); ?>" />
			</div>
